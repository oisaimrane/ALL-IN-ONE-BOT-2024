        ...
        if (interaction.isCommand && interaction.isCommand()) {
            ...
            const createSlashCommandPages = () => {
                ...
                pages.push({
                    ...
                    image: "https://cdn.discordapp.com/attachments/1309556699388055572/1312461808594063522/3lScCLo.gif?ex=674c94cf&is=674b434f&hm=2ccaaf3c670fd57f533f269b72e44156fd969e6b2376d0cca5274cd9ec0ec3c1&",
                    color: "#3498db",
                ...
                for (const [category, commands] of Object.entries(commandData)) {
                    ...
                    switch (category) {
                        case 'anime':
                            page.image = "https://cdn.discordapp.com/attachments/1309556699388055572/1312460974632210495/M2k5r3H.gif?ex=674c9408&is=674b4288&hm=c1146500374aec6228369c48ff749612e70ab128cb71080ec89390c81a17caef&";
                            page.color = "#ff66cc";
